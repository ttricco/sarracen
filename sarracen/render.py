...
def render_2d(data: 'SarracenDataFrame',
    ...
    image = interpolate_2d(data, target, x, y, kernel, pixwidthx, pixwidthy, xmin, ymin, pixcountx, pixcounty)
...
def render_2d_cross(data: 'SarracenDataFrame',
    ...
    output = interpolate_2d_cross(data, target, x, y, kernel, x1, y1, x2, y2, pixcount)
...
def render_3d(data: 'SarracenDataFrame',
    ...
    pixwidthx = (xmax - xmin) / pixcountx
    pixwidthy = (ymax - ymin) / pixcounty
    img = interpolate_3d(data, target, x, y, kernel, pixwidthx, pixwidthy, xmin, ymin, pixcountx, pixcounty,
                         int_samples)
...
def render_3d_cross(data: 'SarracenDataFrame',
    ...
    pixwidthx = (xmax - xmin) / pixcountx
    pixwidthy = (ymax - ymin) / pixcounty
    img = interpolate_3d_cross(data, target, zslice, x, y, z, kernel, pixwidthx, pixwidthy, xmin, ymin, pixcountx,
                               pixcounty)
